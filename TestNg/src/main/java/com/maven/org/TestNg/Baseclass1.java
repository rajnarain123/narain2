...
public class Baseclass1 {
	...
	public static void dropdown(WebElement element, String option, int index, String value) {
	...
	public static void Screenshot(String filename) throws IOException {
		...
		File scr_file = ((TakesScreenshot) ts).getScreenshotAs(OutputType.FILE);
		File dst_file = new File(
				"C:\\Users\\91936\\eclipse-workspace\\Selenium1\\Automation Practice\\ScreenShotnaren1.png");
